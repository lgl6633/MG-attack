...
from model.models import APPNP
import random
...
adj, features, labels, idx_train, idx_val, idx_test = load_data(graph_name = args.dataset, lbl_noise=args.lbl_noise_num, str_noise_rate=args.str_noise_rate, seed = args.seed)
...
model = APPNP(nfeat=features.shape[1],
            ...
            dropout=0.5,
            K=args.K, # 10
            alpha=args.alpha).to(device) # 0.1
...
print("APPNP Optimization Finished!")
